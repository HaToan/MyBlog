                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/user/add" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="fullname" placeholder="Please Enter Users Name"  />
                            </div>


                            <div class="form-group">
                                <label>UserName</label>
                                <input class="form-control" name="username" placeholder="Please Enter Users Name"  />
                            </div>

                            <div class="form-group">
                                <label>Email</label>
                                <input class="form-control" name="email" placeholder="Please Enter  Email "  type="email" />
                            </div>
                        ...
                        <textarea class="form-control" rows="3" name="description"></textarea>
                            ...
                            <button type="submit" class="btn btn-default">Users Add</button>
